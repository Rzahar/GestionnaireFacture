package com.invoise.invoise.repository.database;
/*
...
@Repository
public class InvoiceRepositoryWebDatabase implements InvoiceRepositoryInterface {
    ...
    public List<Invoice> list() {
        return jdbcTemplate.query("SELECT INVOICE_NUMBER,CUSTOMER_NAME FROM INVOICE",
                (rs, rowNum) -> new Invoice(String.valueOf(
